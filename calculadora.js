...
buttom.forEach((item)=>{
    item.onclick=()=>{ /*para reconocer a quien le he dado onclick*/
        ...
        display.innerText=string.substr(0,string,length-2)/* extrae el ultimo caracter,El substring()método devuelve la parte del stringíndice desde el inicio hasta el índice final y excluyendolo, o hasta el final de la cadena si no se proporciona un índice final.*/
